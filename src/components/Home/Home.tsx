...
import bakery2 from '../../assets/image.png';
const Home = () => {
  return (
    <>
      <div className="mt-5 bg-light rounded-3 p-3">
        ...
        <div className="d-flex mt-4">
          <img src={bakery2} alt="bakery" />
          <div>
            <p>
              Casting a warm glow across the sky. As the day
              came to an end, the sounds of nature filled the air, from the chirping of birds to the
              rustling of leaves he sky shifted from orange to pink to purple,
              creating a mesmerizing display that seemed to stretch on for miles. In that moment,
              everything felt right in the world. The worries and stresses of the day melted away,
              leaving only a sense of calm and contentment.
            </p>
      ...
      <footer className="d-flex justify-content-between bg-light p-3 rounded-3 mt-5">
        <a href="#" className="opacity-75">@Travelulu</a>
        <div className="opacity-75">@$travelulu-travelulu.com</div>
      </footer>
    </>
  );
};
